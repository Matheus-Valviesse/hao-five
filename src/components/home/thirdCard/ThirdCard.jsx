...
return (
  <div className='w-full flex min-h-[280px] h-full overflow-hidden '>
    <div className='bg-white flex flex-col text-[#1C1C1C]  py-[30px] px-[60px]  sm:max-w-[60vw] justify-start items-start gap-y-4'>
      <span className='max-h-[200px] h-full w-full block sm:hidden '>
        {/* <ProjectImg  className='w-fit max-h-[200px] bg-cover '/> */}
      </span>
    ...
    {/* <ProjectImg className='max-h-[280px] max-w-[40vw] h-full w-full bg-fuchsia-900'/> */}
   
     <Image src={'/captura.png'} width={100} height={100} alt='a'/>
   
     <Image src={c} width={100} height={100} alt='a'/>
