  ...
  return (
    <div className='w-full max-h-[800px] h-full flex items-center  overflow-hidden' >
      ...
      <div className='absolute z-1 justify-start ml-6 sm:ml-12   '>    
        ...
        <h1 className='text-[#D9D9D9] text-[24px] sm:text-[64px] font-medium w-[200px] sm:w-[420px] leading-[24px] mb-4 sm:mb-10 sm:-ml-1' >Produtora de Conteudo e Audio Visual</h1>
